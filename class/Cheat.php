...
class Cheat
{
	...
	{
		echo "
		<nav class=\"d-flex align-items-center gap-3 \" role=\"navigation\" aria-label=\"pagination\">
		  ...
		  <ul class=\"d-flex list-unstyled gap-3 m-0\">
		  		...
		  		<li><a href=\"#\" class=\"p-2 border text-white text-decoration-none rounded\">2</a></li>
		  		<li><a href=\"#\" class=\"p-2  text-white text-decoration-none rounded\">3</a></li>
		  </ul>
